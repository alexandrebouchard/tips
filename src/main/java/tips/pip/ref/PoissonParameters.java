...
//  
////  private final Map<Language,double[][]> marginalTransitions;
...
//  {
//    return expectedLen * getDeleteRate(expectedLen, intensity);
//  }
//  
//  @Deprecated
...
//  {
//    return intensity / expectedLen / 2.0; //intensity / (1.0 + 1.0/expectedLen);
//  }
//  
//  public static double getInsertionRateFromAdditiveIntensityParam(double expectedLen, double intensity)
//  {
//    return intensity / 2.0; //intensity / (1.0 + expectedLen);
//    
//  }
//  
...
//      for (int i = 0; i < 10; i++)
//      {
//        double mu = 10 * rand.nextDouble();
//        double lambda = 10 * rand.nextDouble();
//        
//        double len = getAsymptoticLengthParameter(lambda, mu);
//        double inte= getIndelIntensityParameter(lambda, mu);
//        
//        
//        
//        Assert.assertEquals(mu, getDeleteRate(len, inte), threshold);
//        Assert.assertEquals(lambda, getInsertionRate(len, inte), threshold);
//      }
//    }
//    
//
...
//      for (int i = 0; i < 10; i++)
//      {
//        double mu = 1; //10 * rand.nextDouble();
//        double lambda = 2; //10 * rand.nextDouble();
//        
//        double len = getAsymptoticLengthParameterForAdditiveIntensityParam(lambda, mu);
//        double inte= getIndelIntensityParameterForAdditiveIntensityParam(lambda, mu);
//        
//        
//        double mu2 = getDeleteRateFromAdditiveIntensityParam(len, inte);
//        double l2 = getInsertionRateFromAdditiveIntensityParam(len, inte);
//        
//        double len2 = getAsymptoticLengthParameterForAdditiveIntensityParam(l2, mu2);;
//        double inte2 = getIndelIntensityParameterForAdditiveIntensityParam(l2, mu2);;
//        
//        Assert.assertEquals(mu, mu2, threshold);
//        Assert.assertEquals(lambda, l2, threshold);
//      }
//    }
//  
//  }
...
//        Encodings.rnaEncodings().nonGapCharactersIndexer(),
//        RateMatrixLoader.k2p(),
//        insRate, delRate);
//  }
//  
...
//  {
//    double insertRate = getInsertionRateFromAdditiveIntensityParam(asymptoticLen, additiveIndelIntensity);
//    double delRate = getDeleteRateFromAdditiveIntensityParam(asymptoticLen, additiveIndelIntensity);
...
//
//  @Override
//  public double getLogLikelihood(LinearizedAlignment linearizedAlignment,
//      RootedTree tree)
//  {
